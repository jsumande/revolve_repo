    ...
    constructor(){
      ...
      startAnimation = (sample,data,position) => {
        if(!this.state.disable){
          ...
          setTimeout( () => {this.detection(data,sample,position)},5); Animated.timing(this.state.circles[data].animatedStyle,{toValue:sample,duration:240,useNativeDriver: true,easing: Easing.elastic(1)}).start( ({finished}) => {});
        }
      }
      ...
      componentDidMount(){
        ...
        let random = global.level_select - 11;
