...
import { StyleSheet,TouchableOpacity,View,Text,Modal,SafeAreaView,Image,ImageBackground,Animated, Dimensions ,Easing,Platform,PlatformIOSStatic   } from 'react-native';
...
export default class Threex4 extends Component {
    ...
    constructor(){
        ...
        this.state = {
          ...
          matches : [
            ...
            {match : 0},{match : 0},{match : 0},{match : 0},{match : 0},{match : 0},
            {match : 0},{match : 0},{match : 0},{match : 0},{match : 0},
          ],
      ...
      componentDidMount(){
        ...
        let random = null;
        if(global.level_select <=70){
           random = global.level_select - 51;
        }
        else{
            random = global.level_select - 71;
        }
      ...
      modal(data,data2) {
        ...
        if(this.state.total_move <=20) { global.level_score[global.level_select - 1].star = 3; this.setState({star : 3}) }
        else if(this.state.total_move <=25 && this.state.total_move >=21){ 
